...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_img_dir', type=str, default='./samples', help='name of the mode')
        parser.add_argument('--save_gmm_img', type=str, default='./testgmm', help='save gmm results for debug')
        ...
        parser.add_argument('--k', type=int, default=4, help='numbers of distributions in GMM')

        # data pattern define
        parser.add_argument('--img_file', type=str, default='/home/data1/celeba-256/train/', help='training and testing dataset')
